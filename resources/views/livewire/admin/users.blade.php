                        ...
                        <x-modal name="edit" :show="$errors->userDeletion->isNotEmpty()" focusable>
                            <div class="p-6">
                                <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
                                    ...
                                    <div class="mt-6">
                                        <x-input-label for="password_confirmation" value="{{ __('Password Confirm') }}" class="" />
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <div class="relative mt-2 w-3/4" x-data="{isOpen: false, selected_role: $wire.form['role'], data: [
                                            {id: 1, name: 'client'},
                                            {id: 2, name: 'psikolog'},
                                        ], getData(id){
                                            ...
                                            <button type="button" @click.prevent="isOpen = !isOpen"
                                                ...
                                                <span class="flex items-center">
                                                    <span class="ml-3 block truncate"
                                                        x-text="getData(selected_role.id)?.name"></span>
                                                    <span x-show="selected_role === ''" class="ml-3 block truncate text-slate-500">
                                                        Pilih Role
                                                    </span>
                                                </span>
                                            ...
                                            <ul x-show="isOpen" x-transition:enter="transition ease-in duration-100"
                                                ...
                                                <template x-for="(item, i) in data" :key="i">
                                                    <li x-on:click="selected_role = item; $wire.form['role'] = item; isOpen = false"
                                                        x-bind:class="selected_roles.includes(item) ? 'bg-indigo-600 text-white' : 'text-gray-900'"
                                    ...
                                    <div class="mt-6 flex justify-end">
                                        ...
                                        <x-danger-button class="ms-3" x-on:click="$dispatch('close')"  wire:click.prevent="updateUser">
                                            {{ __('Update') }}
                                        </x-danger-button>
                                    </div>
                                </form>
