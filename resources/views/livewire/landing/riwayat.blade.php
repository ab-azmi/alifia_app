<div>
    ...
    <table class="max-w-90 m-auto my-10 rounded-lg overflow-hidden">
        ...
        <tbody class="bg-white shadow-lg">
            ...
            <tr>
                <td class="text-center px-16 py-4">{{ $item->psikolog?->dataPsikolog?->name }} {{ $item->psikolog?->dataPsikolog?->degree }}, Psikolog</td>
                @if($item->category == 1)
                ...
                <td class="text-center px-16 py-4">
                    <button wire:click="goToMessage({{ $item->psikolog_id }})" class="text-primary flex gap-1 items-center">
